...
export async function execute(interaction) {
    ...
    if (text === 'The Pound') {
        await interaction.reply('Pound is currently open! [Go adopt a pet from the Pound!](https://www.chickensmoothie.com/poundandlostandfound.php)');
        return;
    }

    if (text === 'The Lost and Found') {
        await interaction.reply('Lost and Found is currently open! [Go adopt a pet from the Lost and Found!](https://www.chickensmoothie.com/poundandlostandfound.php)');
        return;
    }
